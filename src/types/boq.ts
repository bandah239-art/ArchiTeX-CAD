...
export type WorkspacePanel = 'viewer' | 'calculator' | 'boq' | 'geo' | 'ai' | 'vision' | 'realestate' | 'government' | 'documents' | 'wash' | 'energy' | 'intelligence' | 'carbon' | 'schedule' | 'emerging' | 'optimizer' | 'seismic';
